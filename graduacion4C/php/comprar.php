<?php
    ...
    $lugares = $_POST["paquete1"];
        ...
        $statementVerificarDuplicados = "SELECT * FROM usuarios_paquetes 
                                        WHERE id usuarios = $idUsuario AND paquete = 1"; 
    ...
    echo"resulado de insertar paquete1", $resultado;
    }
    }
    ...
    $lugares = $_POST["paquete2"];
        ...
        $statementVerificarDuplicados = "SELECT * FROM usuarios_paquetes 
                                        WHERE id usuarios = $idUsuario AND paquete = 2"; 
    ...
    $resultado = $conexionDB->query($statement);
    echo"resulado de insertar paquete2", $resultado;
    }
    }
    ...
    $lugares = $_POST["paquete3"];
        ...
        $statementVerificarDuplicados = "SELECT * FROM usuarios_paquetes 
                                        WHERE id usuarios = $idUsuario AND paquete = 3"; 
    ...
    $resultado = $conexionDB->query($statement);
    echo"resulado de insertar paquete3", $resultado;
    }
    }
